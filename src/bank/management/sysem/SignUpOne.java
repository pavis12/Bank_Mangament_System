...
public class SignUpOne extends JFrame implements ActionListener{
    ...
    SignUpOne(){
        ...
        formno.setBounds(140,20,600,40);//setBounds works only if setLayout is null
        add(formno);
        
        JLabel personalDetails=new JLabel("Page 1 : Personl Details");
        personalDetails.setFont(new Font("Raleway",Font.BOLD,22));
        personalDetails.setBounds(290,80,400,30);//setBounds works only if setLayout is null
        add(personalDetails);
        ...
        email.setBounds(100,340,200,30);//setBounds works only if setLayout is null
        add(email);
        ...
        add(other);
        ButtonGroup maritalgroup =new ButtonGroup();//grouping so that either of one can be selected
        ...
        city.setBounds(100,490,200,30);//setBounds works only if setLayout is null
        add(city);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(name.equals("")){
                ...
                //to pass the formno.to next page
                setVisible(false);
